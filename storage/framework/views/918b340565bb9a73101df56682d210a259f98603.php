            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="leave-comment mr0"><!--leave comment-->
                        ...
                        <br>
                        <form class="form-horizontal contact-form" role="form" method="post" action="<?php echo e(route('register')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\php-laravel\resources\views/pages/register.blade.php ENDPATH**/ ?>