            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    ...
                    <?php if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->is_admin): ?>
                        <li><a href="<?php echo e(route('adminpanel')); ?>">ADMIN PANEL</a></li>
                    <?php endif; ?>
                ...
                <ul class="nav navbar-nav text-uppercase pull-right">
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo e(route('registerForm')); ?>">Register</a></li>
                        <li><a href="<?php echo e(route('loginForm')); ?>">Login</a></li>
                    <?php endif; ?>
                </ul>
...
<?php /**PATH C:\OpenServer\domains\php-laravel\resources\views/layout.blade.php ENDPATH**/ ?>